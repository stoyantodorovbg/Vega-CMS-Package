...
class RouteTest extends TestCase
{
    ...
    public function the_properties_of_the_created_through_the_console_route_are_validated_as_unique(): void
    {
        ...
        $this->assertCount(1, Route::where('action', 'Front\TestController@test')->get());
    ...
    {
        $this->artisan('generate:route /test~ get TestController@test1 test.test1');
        ...
        $this->artisan('generate:route /test/,{user} get TestController@test2 test.test2');

        $this->assertDatabaseMissing('routes', [
            'url' => '/test/,{user}',
            'action' => 'Front\TestController@test2',
            'name' => 'test.test2',
        ]);

        $this->artisan('generate:route /test/{user} get TestController@test3 test.test3');
    ...
    {
        $this->artisan('generate:route /test1 get TestControllertest test.test1');

        $this->assertDatabaseMissing('routes', [
            'url' => '/test1',
            'action' => 'Front\TestControllertest',
            'name' => 'test.test1',
        ]);

        $this->artisan('generate:route /test2 get TestController@test! test.test2');
        ...
        $this->artisan('generate:route /test/test get TestController@testMethod test.test');

        $this->assertDatabaseHas('routes', [
            'url' => '/test/test',
            'action' => 'Front\TestController@testMethod',
            'name' => 'test.test',
        ]);
    ...
    {
        $this->artisan('generate:route /test1 get TestController@test1 test.test%');
        ...
        $this->artisan('generate:route /test2 get TestController@test2 test.test^)');
        ...
        $this->artisan('generate:route /test/test/{test} get TestController@testTest test.test-test');

        $this->assertDatabaseHas('routes', [
            'url' => '/test/test/{test}',
            'action' => 'Front\TestController@testTest',
            'name' => 'test.test-test',
        ]);

        $this->artisan('destroy:route test.test-test');

        $this->artisan('generate:route /test/test/{test}3 get TestController@testTest3 test.test_test');

        $this->assertDatabaseHas('routes', [
            'url' => '/test/test/{test}3',
            'action' => 'Front\TestController@testTest3',
            'name' => 'test.test_test',
        ]);
    ...
    {
        $this->artisan('generate:route /test1 get1 TestController@test1 test.test')
        ...
        $this->artisan('generate:route /test2 post$ TestController@test2 test.test-test')
            ->expectsOutput('The method format is invalid.');
        ...
        $this->artisan('generate:route /test3 patch$ TestController@test3 test.test-test-test')
            ->expectsOutput('The method format is invalid.');
        ...
        $this->artisan('generate:route /test4 put+ TestController@test4 test.test-_')
            ->expectsOutput('The method format is invalid.');
        ...
        $this->artisan('generate:route /test5 deleteu TestController@test5 test.test5')
            ->expectsOutput('The method format is invalid.');

        $this->assertDatabaseMissing('routes', [
            'url' => '/test5',
            'method' => 'deleteu',
            'action' => 'Front\TestController@test5',
            'name' => 'test.test5',
        ]);

        $this->artisan('generate:route /test5 delete TestController@test5 test.test5')
            ->expectsOutput('The route is generated successfully.');
    ...
    {
        $this->artisan('generate:route /test get TestController@test test.test1');
        ...
        $this->artisan('sync:routes')
            ->expectsOutput('A route with name test.test1, url /test, action Front\TestController@test is stored in DB.');
    ...
    {
        $this->artisan('generate:route /test get TestController@test test.test api admina');

        $this->assertDatabaseMissing('routes', [
            'url' => '/test',
            'action' => 'Admina/TestController@test',
            'name' => 'test.test',
            'route_type' => 'api',
        ]);

        $this->artisan('generate:route /test get TestController@test test.test api pesho');

        $this->assertDatabaseMissing('routes', [
            'url' => '/test',
            'action' => 'Pesho/TestController@test',
            'name' => 'test.test',
            'route_type' => 'api',
        ]);
    }
