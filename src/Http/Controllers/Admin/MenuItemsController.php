...
use Vegacms\Cms\Http\Requests\Admin\AdminMenuItemRequest;
...
class MenuItemsController extends Controller
{
    ...
    public function index(Menu $menu, int $menuItem)
    {
        ...
        return view('vegacms::admin.menu_items.index')->with([
    ...
    {
        return view('vegacms::admin.menu_items.show', compact('menuItem'));
    }
    ...
    public function create()
    {
        ...
        return view('vegacms::admin.menu_items.create', compact('defaultJsonFieldsData', 'menus', 'menuItems'));
    }
    ...
    public function edit(MenuItem $menuItem)
    {
        ...
        return view('vegacms::admin.menu_items.edit', compact('menuItem', 'menus', 'menuItems'));
    }
