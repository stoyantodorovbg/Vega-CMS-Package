...
use Vegacms\Cms\Http\Requests\Admin\AdminRouteRequest;
use Vegacms\Cms\Services\Interfaces\RouteServiceInterface;
use Vegacms\Cms\Http\Requests\Admin\AdminUpdateRouteRequest;
...
class RoutesController extends Controller
{
    ...
    {
        return view('vegacms::admin.routes.index');
    }
    ...
    {
        return view('vegacms::admin.routes.show', compact('route'));
    }
    ...
    {
        return view('vegacms::admin.routes.create');
    }
    ...
    public function edit(Route $route)
    {
        ...
        return view('vegacms::admin.routes.edit', compact('route', 'groups', 'routeGroupsTitles'));
    }
