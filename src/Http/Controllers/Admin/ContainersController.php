...
use Vegacms\Cms\Http\Requests\Admin\AdminContainerRequest;
use Vegacms\Cms\Http\Requests\Admin\AdminContainerIndexRequest;
...
class ContainersController extends Controller
{
    ...
    public function index(AdminContainerIndexRequest $request)
    {
        ...
        return view('vegacms::admin.containers.index')->with([
    ...
    {
        return view('vegacms::admin.containers.show', compact('container'));
    }
    ...
    public function create(DefaultJsonStructureRepositoryInterface $defaultJsonStructureRepository)
    {
        ...
        return view('vegacms::admin.containers.create', compact('defaultJsonFieldsData', 'activeContainers'));
    }
    ...
    public function edit(Container $container)
    {
        ...
        return view('vegacms::admin.containers.edit', compact('container', 'activeContainers', 'parentContainersIds'));
    }
