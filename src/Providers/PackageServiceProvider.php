...
class PackageServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../Http/Controllers/Auth' => app_path('Http/Controllers'),
        ], 'vegacms-auth-controllers');

        $this->publishes([
            __DIR__ . '/../Http/Controllers/Admin/DeleteController.php' => app_path('Http/Controllers/Admin'),
        ...
        $this->publishes([
            __DIR__ . '/../../resources/views/admin/layouts' => resource_path('vendor/vegacms/views/admin/layouts'),
